...
s.t. c0{p in CP1,c in C: active_coord1[p,c]>0}: coordDelay1[p,c] = ( zetatl[p,c] - Cl1[p,c]*zeta1[p,c] ) + (-zetatu[p,c] + Cu1[p,c]*zeta2[p,c]);
s.t. cc0{p in CP2,c in C: active_coord2[p,c]>0}: coordDelay2[p,c] = ( gammatl[p,c] - Cl2[p,c]*gamma1[p,c] ) + (-gammatu[p,c] + Cu2[p,c]*gamma2[p,c]);
s.t. c1{p in CP1: active_coord1[p,1]>0}: M*zeta1[p,1] >= (coef[p,1]*t[p,1,1]+(1-coef[p,1])*t[p,2,1]) - Cl1[p,1]; 
s.t. c2{p in CP1: active_coord1[p,1]>0}: Cl1[p,1] - (coef[p,1]*t[p,1,1]+(1-coef[p,1])*t[p,2,1]) <= M*(1-zeta1[p,1]);
s.t. c3{p in CP1: active_coord1[p,1]>0}: (coef[p,1]*t[p,1,1]+(1-coef[p,1])*t[p,2,1]) - M*(1-zeta1[p,1]) <= zetatl[p,1]; 
s.t. c4{p in CP1: active_coord1[p,1]>0}: zetatl[p,1] <= (coef[p,1]*t[p,1,1]+(1-coef[p,1])*t[p,2,1]) + M*(1-zeta1[p,1]) ; 
s.t. c5{p in CP1: active_coord1[p,1]>0}: zetatl[p,1] <= M*zeta1[p,1]; 
s.t. c6{p in CP1: active_coord1[p,2]>0}: M*zeta1[p,2] >= (coef[p,1]*t[p,2,1]+(1-coef[p,1])*t[p,3,1]) - Cl1[p,2]; 
s.t. c7{p in CP1: active_coord1[p,2]>0}: Cl1[p,2] - (coef[p,1]*t[p,2,1]+(1-coef[p,1])*t[p,3,1]) <= M*(1-zeta1[p,2]);
s.t. c8{p in CP1: active_coord1[p,2]>0}: (coef[p,1]*t[p,2,1]+(1-coef[p,1])*t[p,3,1]) - M*(1-zeta1[p,2]) <= zetatl[p,2]; 
s.t. c9{p in CP1: active_coord1[p,2]>0}: zetatl[p,2] <= (coef[p,1]*t[p,2,1]+(1-coef[p,1])*t[p,3,1]) + M*(1-zeta1[p,2]) ; 
s.t. c10{p in CP1: active_coord1[p,2]>0}: zetatl[p,2] <= M*zeta1[p,2]; 
s.t. c11{p in CP1: active_coord1[p,1]>0}: M*zeta2[p,1] >= Cu1[p,1] - coef[p,1]*(g[p,1,1]+t[p,1,1]) - (1-coef[p,1])*(g[p,2,1]+t[p,2,1]); 
s.t. c12{p in CP1: active_coord1[p,1]>0}: coef[p,1]*(g[p,1,1]+t[p,1,1]) + (1-coef[p,1])*(g[p,2,1]+t[p,2,1]) - Cu1[p,1] <= M*(1-zeta2[p,1]); 
s.t. c13{p in CP1: active_coord1[p,1]>0}: coef[p,1]*(g[p,1,1]+t[p,1,1]) + (1-coef[p,1])*(g[p,2,1]+t[p,2,1]) - M*(1-zeta2[p,1]) <= zetatu[p,1]; 
s.t. c14{p in CP1: active_coord1[p,1]>0}: zetatu[p,1] <= coef[p,1]*(g[p,1,1]+t[p,1,1]) + (1-coef[p,1])*(g[p,2,1]+t[p,2,1]) + M*(1-zeta2[p,1]) ; 
s.t. c15{p in CP1: active_coord1[p,1]>0}: zetatu[p,1] <= M*zeta2[p,1]; 
s.t. c16{p in CP1: active_coord1[p,2]>0}: M*zeta2[p,2] >= Cu1[p,2]- coef[p,1]*(g[p,2,1]+t[p,2,1]) - (1-coef[p,1])*(g[p,3,1]+t[p,3,1]); 
s.t. c17{p in CP1: active_coord1[p,2]>0}: (coef[p,1])*(g[p,2,1]+t[p,2,1]) + (1-coef[p,1])*(g[p,3,1]+t[p,3,1])-Cu1[p,2] <= M*(1-zeta2[p,2]); 
s.t. c18{p in CP1: active_coord1[p,2]>0}: coef[p,1]*(g[p,2,1]+t[p,2,1]) + (1-coef[p,1])*(g[p,3,1]+t[p,3,1]) - M*(1-zeta2[p,2])  <= zetatu[p,2]; 
s.t. c19{p in CP1: active_coord1[p,2]>0}: zetatu[p,2] <=  coef[p,1]*(g[p,2,1]+t[p,2,1]) + (1-coef[p,1])*(g[p,3,1]+t[p,3,1])+ M*(1-zeta2[p,2]) ;
s.t. c20{p in CP1: active_coord1[p,2]>0}: zetatu[p,2] <= M*zeta2[p,2];
s.t. cc1{p in CP2: active_coord2[p,1]>0}: M*gamma1[p,1] >= (coef[p,1]*t[p,1,1]+(1-coef[p,1])*t[p,2,1]) - Cl2[p,1];
s.t. cc2{p in CP2: active_coord2[p,1]>0}: Cl2[p,1] - (coef[p,1]*t[p,1,1]+(1-coef[p,1])*t[p,2,1]) <= M*(1-gamma1[p,1]);
s.t. cc3{p in CP2: active_coord2[p,1]>0}: (coef[p,1]*t[p,1,1]+(1-coef[p,1])*t[p,2,1]) - M*(1-gamma1[p,1]) <= gammatl[p,1]; 
s.t. cc4{p in CP2: active_coord2[p,1]>0}: gammatl[p,1] <= (coef[p,1]*t[p,1,1]+(1-coef[p,1])*t[p,2,1]) + M*(1-gamma1[p,1]);
s.t. cc5{p in CP2: active_coord2[p,1]>0}: gammatl[p,1] <= M*gamma1[p,1]; 
s.t. cc6{p in CP2: active_coord2[p,2]>0}: M*gamma1[p,2] >= (coef[p,1]*t[p,2,1]+(1-coef[p,1])*t[p,3,1]) - Cl2[p,2];
s.t. cc7{p in CP2: active_coord2[p,2]>0}: Cl2[p,2] - (coef[p,1]*t[p,2,1]+(1-coef[p,1])*t[p,3,1]) <= M*(1-gamma1[p,2]);
s.t. cc8{p in CP2: active_coord2[p,2]>0}: (coef[p,1]*t[p,2,1]+(1-coef[p,1])*t[p,3,1]) - M*(1-gamma1[p,2]) <= gammatl[p,2]; 
s.t. cc9{p in CP2: active_coord2[p,2]>0}: gammatl[p,2] <= (coef[p,1]*t[p,2,1]+(1-coef[p,1])*t[p,3,1]) + M*(1-gamma1[p,2]);
s.t. cc10{p in CP2: active_coord2[p,2]>0}: gammatl[p,2] <= M*gamma1[p,2]; 
s.t. cc11{p in CP2: active_coord2[p,1]>0}: M*gamma2[p,1] >= Cu2[p,1]-coef[p,1]*(g[p,1,1]+t[p,1,1]) - (1-coef[p,1])*(g[p,2,1]+t[p,2,1]); 
s.t. cc12{p in CP2: active_coord2[p,1]>0}: coef[p,1]*(g[p,1,1]+t[p,1,1]) + (1-coef[p,1])*(g[p,2,1]+t[p,2,1]) - Cu2[p,1] <= M*(1-gamma2[p,1]); 
s.t. cc13{p in CP2: active_coord2[p,1]>0}: coef[p,1]*(g[p,1,1]+t[p,1,1]) + (1-coef[p,1])*(g[p,2,1]+t[p,2,1]) - M*(1-gamma2[p,1]) <= gammatu[p,1]; 
s.t. cc14{p in CP2: active_coord2[p,1]>0}: gammatu[p,1] <= coef[p,1]*(g[p,1,1]+t[p,1,1]) + (1-coef[p,1])*(g[p,2,1]+t[p,2,1]) + M*(1-gamma2[p,1]) ;
s.t. cc15{p in CP2: active_coord2[p,1]>0}: gammatu[p,1] <= M*gamma2[p,1]; 
s.t. cc16{p in CP2: active_coord2[p,2]>0}: M*gamma2[p,2] >= Cu2[p,2]-coef[p,1]*(g[p,2,1]+t[p,2,1]) - (1-coef[p,1])*(g[p,3,1]+t[p,3,1]); 
s.t. cc17{p in CP2: active_coord2[p,2]>0}: (coef[p,1])*(g[p,2,1]+t[p,2,1]) + (1-coef[p,1])*(g[p,3,1]+t[p,3,1])-Cu2[p,2] <= M*(1-gamma2[p,2]);
s.t. cc18{p in CP2: active_coord2[p,2]>0}: coef[p,1]*(g[p,2,1]+t[p,2,1]) + (1-coef[p,1])*(g[p,3,1]+t[p,3,1]) - M*(1-gamma2[p,2])  <= gammatu[p,2]; 
s.t. cc19{p in CP2: active_coord2[p,2]>0}: gammatu[p,2] <=  coef[p,1]*(g[p,2,1]+t[p,2,1]) + (1-coef[p,1])*(g[p,3,1]+t[p,3,1])+ M*(1-gamma2[p,2]) ;
s.t. cc20{p in CP2: active_coord2[p,2]>0}: gammatu[p,2] <= M*gamma2[p,2]; 
...
for {c in C,p in CP: active_coord2[p,c]>0} 
        { 
