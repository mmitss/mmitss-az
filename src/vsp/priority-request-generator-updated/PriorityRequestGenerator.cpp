...
// 	signalRequest.setTemporaryVechileID(setVehicleID(basicVehicle));
...
void PriorityRequestGenerator::setMsgCount(SrmManager srmManager)
{
	msgCount = srmManager.getMessageCount();
}
