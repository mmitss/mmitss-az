...
if __name__ == "__main__":
    ...
    with open("v2x-data-sftp-client-config.json", 'r') as configFile:
        config = json.load(configFile)

    localDataDirectory = config["local_data_directory"]
    intersections = config["intersections"]
    startHour = config["data_transfer_start_24h"]["hour"]
    startMinute = config["data_transfer_start_24h"]["minute"]
