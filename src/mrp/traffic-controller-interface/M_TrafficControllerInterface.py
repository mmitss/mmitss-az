    ...
    while(True):
        ...
        if receivedMessage["MsgType"]=="Schedule":
            if receivedMessage["Schedule"] == "Clear":
                # Clear the all scheduled jobs from the BackgroundScheduler, and reschedule the updating of the activeTimingplan:
                ...
                # Let the object of the Scheduler class process the new schedule:
