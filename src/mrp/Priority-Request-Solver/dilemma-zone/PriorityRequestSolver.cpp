...
void PriorityRequestSolver::createPriorityRequestList(string jsonString)
{
    ...
    for (int i = 0; i < noOfRequest; i++)
    {
        ...
        // requestList.vehicleDistanceFromStopBar = jsonObject["PriorityRequestList"]["requestorInfo"][i]["speed_MeterPerSecond"].asDouble() * 3.28084 *jsonObject["PriorityRequestList"]["requestorInfo"][i]["ETA"].asDouble();
    ...
    {
        cout << priorityRequestList[i].vehicleID << " " << priorityRequestList[i].requestedPhase << " " << priorityRequestList[i].vehicleETA << " " << priorityRequestList[i].vehicleDistanceFromStopBar << endl;
    }
}
...
void PriorityRequestSolver::getCurrentSignalStatus()
{
    ...
    for (int i = 0; i < 2; i++)
    {
        ...
        else if (temporaryPhaseState == "yellow") //8 means yellow
        {
