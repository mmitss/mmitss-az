...
s.t. Prec_21_22_c23{e in E,p in P22, k in K: coef[p,k]=1 and (card(P22)+p)=8 and k>1 }:  t[p,k,e]=t[6,k,e]+v[6,k,e];
...
s.t. Prec_22_21_c23{e in E,p in P21, k in K: (card(P21)+p+1)=8 and k>1 }:    t[p,k,e]=t[7,k-1,e]+v[7,k-1,e];
