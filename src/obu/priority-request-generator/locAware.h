...
class LocAware
{
	...
	public:
		...
		~LocAware(void);
		uint8_t getLaneIdByIndexes(const uint8_t& intersectionIndx, const uint8_t& approachIndx, const uint8_t& laneIndx) const; //This method was private in mapengine Library. 
