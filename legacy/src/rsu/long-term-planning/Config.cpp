...
//!!! B.H : For long term planning
void ReadInConfig_long(char *filename, char* filename2)
{
    //-------------------------------------------------------------------------------//
    //* Important * Read the configuration: Find out the Missing phase and MP_Relate
    fstream FileRead;
    ...
    double iCoordinationPhaseSplit[8];
    ...
    while(!FileRead2.eof())
    {
        ...
        {
            sscanf(lineread.c_str(),"%s",TempStr);
            if(strcmp(TempStr,"coordination_phase_split")==0)
            {
                sscanf(lineread.c_str(),"%*s %lf %lf %lf %lf %lf %lf %lf %lf ",&iCoordinationPhaseSplit[0],&iCoordinationPhaseSplit[1], &iCoordinationPhaseSplit[2], &iCoordinationPhaseSplit[3], &iCoordinationPhaseSplit[4], &iCoordinationPhaseSplit[5], &iCoordinationPhaseSplit[6], &iCoordinationPhaseSplit[7] );
            }
        }
    }
    FileRead2.close();
    ...
    //!!! B.H 
    ConfigIS.iCoordinationPhaseSplit[0]=iCoordinationPhaseSplit[0]; ConfigIS.iCoordinationPhaseSplit[1]=iCoordinationPhaseSplit[1]; ConfigIS.iCoordinationPhaseSplit[2]=iCoordinationPhaseSplit[2];
    ConfigIS.iCoordinationPhaseSplit[3]=iCoordinationPhaseSplit[3]; ConfigIS.iCoordinationPhaseSplit[4]=iCoordinationPhaseSplit[4]; ConfigIS.iCoordinationPhaseSplit[5]=iCoordinationPhaseSplit[5];
    ConfigIS.iCoordinationPhaseSplit[6]=iCoordinationPhaseSplit[6]; ConfigIS.iCoordinationPhaseSplit[7]=iCoordinationPhaseSplit[7];
