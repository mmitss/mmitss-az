...
{
public:
	int VehID; //!!!char VehID[64];			//  The ID of the vehicle 
	int VehClass;		//	The Class of the vehicle
	double ETA;			//	The Estimation Time of Arrival
...
public:
    ...
    ReqEntry(int vehID, int VehClass, double eta, int phase,float mgreen, int absTime, int split_phase,int iInLane,int iOutLane,int iStrHour,int iStrMinute,int iStrSecond,int iEndHour,int iEndMinute,int iEndSecond,int iVehState	, int iMsgCnt);
...
//public:
	//ReqEntry();
	//ReqEntry(char *vehID, int VehClass, float eta, int phase,float mgreen, float fsetRequestTime, int split_phase,int iInLane,int iOutLane,int iStrHour,int iStrMinute,int iStrSecond,int iEndHour,int iEndMinute,int iEndSecond,int iVehState	, int iMsgCnt);
    //ReqEntry(ReqEntry& Req);
	//ReqEntry& operator=(ReqEntry& Req);
	//int Display(char *logfilename);
//public:
